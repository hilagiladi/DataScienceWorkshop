...
```
    ...
    Original training set distribution: HeartDisease
    0    233802
    1     21846
...
![png](main_files/main_125_0.png)
    



    
![png](main_files/main_125_1.png)
...
```
    ...
    Logistic Regression      0.70               0.97            0.70        0.81            0.19         0.73     0.30
          Random Forest      0.82               0.93            0.87        0.90            0.20         0.35     0.26
         Neural Network      0.74               0.96            0.75        0.84            0.20         0.65     0.30
                XGBoost      0.73               0.97            0.73        0.83            0.20         0.73     0.32
    


    
![png](main_files/main_128_1.png)
...
It's worth noting that all models were evaluated both before and after SMOTE balancing. This allowed us to see which models are more sensitive to class imbalance, and how balancing affects their ability to detect true cases — a critical factor in healthcare applications
...
```
    ...
    100%|===================| 63774/63913 [03:24<00:00]        


    
![png](main_files/main_131_1.png)
...
![png](main_files/main_134_0.png)
    



    
![png](main_files/main_134_1.png)
    



    
![png](main_files/main_134_2.png)
    



    
![png](main_files/main_134_3.png)
